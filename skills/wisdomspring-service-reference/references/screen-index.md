...
Use this file to quickly find the right bundled markdown reference under `references/screen-plans/`.

## Core screens

| Shared ID | Main purpose | Reference file |
| --- | --- | --- |
...
| `FD-B030` / `FD-M030` | 답변 작성 레이어 | `screen-plans/FD-B030 FD-M030 답변 작성.md` |
| `PR-001` / `PR-120` | 프로필의 생각기록, 오늘의 질문 이력 | `screen-plans/PR-001 PR-120 프로필의 생각기록-오늘의 질문.md` |
...
| Shared or platform ID | Main purpose | Reference file |
| --- | --- | --- |
